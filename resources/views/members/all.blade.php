...
$(document).ready(function () {
    ...
    users_table = $('#users-table').DataTable({
        ...
        columns: [
          ...
          //  { title: "Nome", data: {nome_completo: 'nome_completo'}, name: 'fullname', render: (data) => ('${data.nome_completo}') },
            // { title: "Occupation", data: 'occupation', name: 'occupation' },
     //       { title: "Status", data: {status: 'status', id: 'id', nome_completo: 'nome_completo'}, name: 'status',
     //        render: (data) => (`${data.status == 'new' }
