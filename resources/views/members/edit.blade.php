...
<div id="content-container">
    ...
    <div id="page-head">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div id="page-title">
            <h1 class="page-header text-overflow">Editar Membro</h1>
        </div>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End page title-->
        <!--Breadcrumb-->
...
<!--            <li>
            ...
            <li>
                <a href="{{route('members.all')}}">Membro</a>
            </li>
                        
            <li class="active">Edição de Membro</li>
        </ol>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End breadcrumb-->
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="panel rounded-top" style="background-color: #e8ddd3;">
                    <div class="panel-heading">
                        <h1 class="text-center" style="padding-top:5px">Editar Membro </h2>
                    </div>
                ...
                ?>
                    ...
                    <div class="row panel-body" style="background-color: #e8ddd3;">
                        <div class=""  style="border:1pt solid #090c5e; border-radius:25px;">
                            ...
                            <form method="POST" action="{{route('member.update',$member->id)}}" class="panel-body form-horizontal form-padding" enctype="multipart/form-data">
<!--                        <form method="POST" action="{{ route('member.edit', ['id' => $member->id]) }}"  class="panel-body form-horizontal form-padding" enctype="multipart/form-data">-->
                            @csrf   
                             {!! method_field('PUT') !!} 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="cpf" name="cpf" value="{{$member->cpf}}" class="form-control" placeholder="CPF" required>
                                        </div>
                                    </div>
                                    <!--RG-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="rg" name="rg" class="form-control" value="{{$member->rg}}" placeholder="RG" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <input id="dob" type="text" placeholder="Data de Nascimento" value="{{$member->dob}}" name="dob" class="datepicker form-control" required/>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="email" type="email" id="demo-email-input" class="form-control" value="{{$member->email}}" name="email" placeholder="Informe o email" required>
                                        </div>
                                    </div>
                                    <!--TELEFONE-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="phone" type="text" class="form-control" name="phone" value="{{$member->phone}}" placeholder="Digite o número do celular" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="occupation" type="text" class="form-control" value="{{$member->occupation}}" name="occupation" placeholder="Informe sua profissão">
                                        </div>
                                    </div>
                                    <!--FUNCAO ECLESIASTICA-->
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="position" name="position" >
                                                          <option value="{{$position}}"
                                                                @if( isset($position) && $member->position == $position )
                                                            selected
                                                            @endif    
                                                            >{{$position}}                                         
                                                        </option>     
                            ...
                            <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                              <div class="radio">
                                                <input id="demo-form-radio" class="magic-radio" value="SIM" type="radio" name="batismo_status" <?php if ($batismo_status == 'sim') {
                                                        echo 'checked';
                                                    } ?> >
                                                <label for="demo-form-radio">SIM</label>
                                                <input id="demo-form-radio-2" class="magic-radio" value="NÃO" type="radio" name="batismo_status" <?php if ($batismo_status == 'nao') {
                                                        echo 'checked';
                                                    } ?> >
                                                <label for="demo-form-radio-2">NÃO</label>
                                            </div>
                                        </div> 
                              </div>
                               ...
                               <!--DATA BATISMO-->
                                <div id="wedding_batismo" class="form-group" style="display:none">
                                    ...
                                    <div class="col-md-9">
                                        <input id="data_batismo"  type="text" placeholder="Data de Batismo" value="{{$member->data_batismo}}" name="data_batismo" class="datepicker form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if ($ipInfo['continent'] != 'Africa') { ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="postal" type="text" class="form-control" name="postal"  value="{{$member->postal}}" placeholder="Informe o CEP" onblur="pesquisacep(this.value);" />
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="city" type="text" class="form-control" name="city" value="{{$member->city}}" placeholder="Informe a Cidade" required>
                                        </div>
                                    </div>
                                    <!--ESTADO-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="state" type="text" class="form-control" name="state" value="{{$member->state}}" placeholder="Informe o Estado" required>
                                        </div>
                                    </div>
                                    <!--PAIS-->
                                    <div class="form-group">
                            ...
                            <!--SEXO-->
                                    <div class="form-group pad-ve">
                                        ...
                                        <div class="col-md-9">
                                            <div class="radio">
                                                <input id="demo-form-radio" class="magic-radio" value="masculino" type="radio" name="sexo" <?php if ($sexo == 'Masculino') {
                                                        echo 'checked';
                                                    } ?> >
                                                <label for="demo-form-radio">Masculino</label>
                                                <input id="demo-form-radio-2" class="magic-radio" value="feminino" type="radio" name="sexo" <?php if ($sexo == 'Feminino') {
                                                        echo 'checked';
                                                    } ?> >
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="estado_civil" name="estado_civil" >
                                                    <option value="{{$estado_civil}}"
                                                            @if( isset($estado_civil) && $member->estado_civil == $estado_civil )
                                                        selected
                                                        @endif    
                                                        >{{$estado_civil}}                                         
                                                    </option>
                            ...
                            <div id="wedding" class="form-group" style="display:none">
                                ...
                                <div class="col-md-9">
                                    <input id="wedding_anniversary"  type="text" placeholder="Aniversário Casamento" value="{{$member->wedding_anniversary}}" name="wedding_anniversary" class="datepicker form-control"/>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select class="form-control" id="status" name="status">                                           
                                               <option value="{{$status}}"
                                                            @if( isset($status) && $member->status == $status )
                                                        selected
                                                        @endif    
                                                        >{{$status}}                                         
                                                    </option>                                                    
                                ...
                                <div class="col-md-9">
                                    <span class=" pull-right">
                                        <button id="submit" class="btn btn-info pull-center" align="center" type="submit">ENVIAR</button>
                                    </span>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <span class=" pull-right">
                                        <button class="btn-danger" align="center" onclick="resetForm('#update-form')" >LIMPAR</button>
                                    </span>
                                </div>
                            </form>
                        </div>
                                                    ...
                                                    <script>
                                                                                                 ...
                                                                                                 $(document).ready(function () {
                                                                                                     ...
                                                                                                     $('#edit-form').on('submit', (e) => {
                                                                                                         ...
                                                                                                         //send to db route
                                                                                                         $.ajax({url: "{{route('member.edit')}}", data, type: 'GET'})
                                                                                                                 .done((res) => {
                                                                                                                     if (res.status) {
