		        ...
		        <div class="panel-body  bg-warning shadow-lg p-3 mb-5 rounded">
                    ...
                    @csrf
		                ...
		                <div class="checkbox pad-btm text-left">
		                    ...
		                    <label class="font-weight-bold" for="demo-form-checkbox" style="">Lembre de mim</label>
		                </div>
		                <button class="btn btn-primary btn-lg btn-block" type="submit">Logar em</button>
		            </form>

                <div class="pad-all">
    		            <a href="{{route('recover')}}" class="btn-link mar-rgt">Esqueceu a senha ?</a>
