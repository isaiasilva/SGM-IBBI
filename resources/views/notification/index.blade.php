...
@section('title') Anúncios Gerais @endsection
...
<div id="content-container">
  <div id="page-head">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
      <h1 class="page-header text-overflow">Criar Anúncios</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
    <!--Breadcrumb-->
      ...
      <div class="col-lg-8 col-lg-offset-2">
        <div class="panel">
          <div class="panel-heading">
            <h1 class="text-center" style="padding-top:5px">Criar Anúncios</h2>
          </div>
              ...
              <!--===================================================-->
                 <form id="send-announcement-form" role="form"  method="POST" action="{{route('calendar.announcement')}}">
                                  ...
                                  <?php }?>
                                            ...
                                            <div class="col-md-4 mar-btm">
                                                 <label class=" control-label" for="inputSubject">Por quem</label>
                                ...
                                @endif
                                            ...
                                            <div class="col-md-4 mar-btm">
                                                         <label class=" control-label" for="inputSubject">Hora de início</label>
                                ...
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                         ...
                                         <div class="row">
                                               <div class="col-md-4 mar-btm">
                                                         <label class=" control-label" for="inputSubject">Parar temporizador</label>
                                  <div class="input-group clockpicker col-md-9">
                                ...
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                                 ...
                                                 <div class="col-md-4 mar-btm">
                                                         <label class="control-label" for="inputSubject">Data de início</label>
                    ...
                    <br>
                                ...
                                @endif
                                          ...
                                          <div class="col-md-4 mar-btm">
                                                         <label class=" control-label" for="inputSubject">Parar data</label>
                                             <input style="border:1px solid rgba(0,0,0,0.07);height: 33px;
                                  font-size: 13px;
                                  border-radius: 3px;display: block;
                                  width: 100%;
                                ...
                                @endif
                                    ...
                                    <div class="panel-footer text-right">
                                       <button id="mail-send-btn" type="submit" class="btn btn-primary">
                                                <i class="demo-psi-mail-send icon-lg icon-fw"></i> Criar Anúncio
                                            </button>
                                    </div>
                                </form>
            </div>
