                                        ...
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="forms-general.html#">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="mar-no text-nowrap text-main text-semibold">Novo Usuário</p>
                                            ...
                                            <li>
                                                <a class="media" href="forms-general.html#">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="mar-no text-nowrap text-main text-semibold">IBBI enviou uma mensagem para você</p>
