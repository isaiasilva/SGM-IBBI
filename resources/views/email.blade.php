...
<html>
  <head>
    ...
    <title>E-mail transacional simples</title>
    <style>
 ...
 <p>
  Você recebeu a mensagem de : {{$request->email}}
</p>
 ...
 <br>
 Você recebeu uma mensagem de : {{$request->email}}
 ...
 Error Code : {{$request->error_code }}  ||  Ticket ID : {{$request->TicketID}}  ||  Error Name : {{$request->error_name}}
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="body">
   ...
   <!-- START CENTERED WHITE CONTAINER -->
            <span class="preheader">Este é o texto do cabeçalho anterior. Alguns clientes mostrarão este texto como uma visualização.</span>
            <table class="main">
              <tr>
                <td class="wrapper">
