...
<div id="content-container">
  <div id="page-head">
    ...
    <div class="text-center">
      <h3>Bem-vindo ao SGMIBBI (Sistema de Gestão de Membros )<strong>{{strtoupper($user->branchname)}}</strong> </h3>
      <h2> “E digo isto: Que o que semeia pouco, pouco também ceifará;
      ...
      <div class="panel-body">
          <div class="row mar-top">
              <div class="col-md-4 text-center">
                  <h3 class="text-main text-normal text-2x mar-no">Estatísticas dos Membros</h3>
                        ...
                        <table class="table table-condensed table-trans">
                            <tr>
                                <td class="text-lg" style="width: 40px">
                                  <span class="badge badge-purple" style="background-color: {{$colors[0]}}" id="member-masculino">0</span></td>
                                <td>Masculino</td>
                            </tr>
                            <tr>
                                <td class="text-lg">
                                  <span class="badge badge-dark" style="background-color: {{$colors[1]}}" id="member-feminino">0</span></td>
                                <td>Feminino</td>
                            </tr>
                            <hr>
                            <tr>
  ...
  <div class="panel">
    <div id="manual-analysis-hd" class="text-center bg-primary">
      ...
      <div class="panel-body">
          <div class="row mar-top">
              <div class="col-md-4">
                  <h3 class="text-main text-normal text-2x mar-no">Estatísticas da Coleção</h3>
                  <!-- <h5 class="text-uppercase text-muted text-normal">Report for last 12 Months</h5> -->
                  <div class="row mar-top">
                      <div class="col">
                          <table class="table table-condensed table-trans">
                            ...
                            <tr>
                                <td class="text-lg" style="width: 40px"><span style="background-color: {{$colors[$i]}}"
                                  class="badge badge-purple" id="collection-{{$type->nome_completo}}">N0</span></td>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-{{$isAdmin ? '4' : '6'}}">
                    ...
                    <select id="show" required style="outline:none;" name="sort" class="selectpicker col-md-12" data-style="btn-primary">
                      <option selected value="false">Esta congregação</option>
                      <option value="true">Todas as congregações</option>
                    </select>
                  </div>
                  @endif
                  <div class="col-xs-{{$isAdmin ? '4' : '6'}}">
                  ...
                  <div class="col-xs-{{$isAdmin ? '4' : '6'}}">
                    <label for="range" class="">Selecionar Intervalo</label>
                    <select id="m-i" required style="outline:none;" name="range" class="selectpicker col-md-12 nav nav-pills ranges" data-style="btn-primary">
                      <option selected disabled value="">Escolha o número de meses</option>
                      @for($i = 1; $i < 13; $i++)
                      <option value="{{$i}}">Last{{$i}} Meses</option>
                      @endfor
                    </select>
                  </div>
                </div>
  ...
  <div class="panel">
      ...
      <div class="panel-body">
          <div class="row mar-top">
              <div class="col-md-4">
                  <h3 class="text-main text-normal text-2x mar-no">Estatísticas de Presença</h3>
                  <!-- <h5 class="text-uppercase text-muted text-normal">Report for last 12 Months</h5> -->
                  <div class="row mar-top">
                      <div class="col">
                          <table class="table table-condensed table-trans">
    ...
    <div class="col-md-6">
        <div class="panel">
          <div class="panel-heading"> <!--body text-center"-->
              <h3 class="panel-title"><strong>Aniversariantes de Casamento de:  <?php echo date('F Y'); $i = 1; ?></strong> </h3>
            ...
            <div class="panel-body text-center clearfix">
              @if(count($celebs) > 0)
                        ...
                        <tbody>
                          ...
                          @if(date('F', (strtotime($member->wedding_anniversary))) == date('F'))
                            <tr>
                                ...
                                <span class="label label-table label-success">Próximo</span>
                                @else
                                <span class="label label-table label-purple">Anterior</span>
                                @endif
                                </td>
                ...
                @else
                <p class="text-danger"> Não Aniversário </p>
                @endif
            </div>
        </div>
    </div>
      ...
      <div class="col-md-6">
          <div class="panel">
            <div class="panel-heading"> <!--body text-center"-->
                <h3 class="panel-title"><strong>Aniversariantes do mês: <?php echo date('F Y'); ?></strong> </h3>
                <!--i class="demo-pli-coin icon-4x"></i-->
            </div>
              <div class="panel-body text-center clearfix">
                @if(count($celebs) > 0)
                      ...
                      <table id="dobs" class="table table-vcenter mar-top">
                          ...
                          <tbody>
                            ...
                            @if(date('F', (strtotime($member->dob))) == date('F'))
                              <tr>
                                  <td class="min-w-td">{{$i}}</td>
                                  <td class="text-center"><img src="{{url('/public/images/')}}/{{$member->photo}}" alt="{{$member->nome_completo}} image" class="img-circle img-sm"></td>
                                  <td class="text-center"><a class="btn-link" href="{{$member->profile()}}">{{ucwords($member->getFullname())}}</a></td>
                                  <td class="text-center">{{$member->email}}</td>
                                  <td class="text-center">
  ...
  <div class="panel">
    <div class="panel-body">
      <div class="row mar-top">
        <div class="col-md-3">
          <div class="pad-all text-center">
              <span class="pad-ver text-main text-sm text-uppercase text-bold">Total Vencimento Comissão de Cobranças</span>
        ...
        <div class="col-md-{{($user->isAdmin()) ? 5 : 9}}">
          <h3 class="text-center">Cobranças Devidas</h3>
          <div class="table-responsive">
        ...
        @if($user->isAdmin())
        <div class="col-md-4">
          <h3 class="text-center">Congregações conquistadas</h3>
          <div class="table-responsive">
      ...
      <div class="col-md-6">
          <div class="panel">
              <div class="panel-heading">
                <h1 class="text-bold text-center ji">Próximos eventos para {{strtoupper($user->branchname)}}</h1>
              </div>
              ...
              <div class="panel-footer text-center">
                  ...
                  @if(count($eventss) < 1)
                    <p class="text-danger" > Sem Eventos </p>
                  @endif
      ...
      <div class="col-md-6">
        @if(session()->has('message.level'))
         ...
         @endif
          <div class="panel">
              <div class="panel-heading">
                  <h1 class="text-bold text-center ji">Placa do anúncio</h1>
              </div>
                    ...
                    @if ($event->start_date >= now())
                      <div class="panel-body bord-btm">
                          ...
                          <a href="#" class="task-footer">
                              <span class="box-inline">
                                  <label class="label label-warning">De <i class="icofont-location-arrow"></i> {{$event->branchname}}</label>
                                  <label class="label label-danger">Para <i class="icofont-user"></i> {{ucwords($event->by_who)}}</label>
              ...
              <div class="panel-footer text-center">
                @if(count($eventsall) < 1)
                  <p class="text-danger" > Nenhum novo anúncio </p>
                @endif
  ...
  <div class="row">
    ...
    <div class="col-xs-12">
        <div class="panel">
            <div class="panel-heading">
              <h1 class="text-bold text-center ji">Status de pagamentos</h1>
            </div>
